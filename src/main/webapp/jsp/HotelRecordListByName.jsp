...
<%List<Hotel> hotelListByName = (List<Hotel>)session.getAttribute("hotelListByName");%>
...
<%--        <div class="col-sm-2"><h3 class="text-center" style="margin-top: 26px">Welcome：xxx</h3></div>--%>
    ...
    <table class="table  table-hover table-bordered" style="background-color: #FF6767">
        ...
        <%
            ...
            if(hotelListByName != null){
                System.out.println(hotelListByName.size());
                for (int i=0; i<hotelListByName.size();i++){
                    Hotel hotel1 = (Hotel) hotelListByName.get(i);
        %>
