    ...
    <div class="row">
            ...
            <div class="hotel-frame">
                <div class="hotel-info">
                    <div class="hotel-left">
                        <h3 class="hotel-name">Jasmine Villa</h3>
                        <p class="hotel-nation">the United States</p>
                        <img class="hotel-pic" src="../image/image1/villapicture1.jpg" alt="hotel pic">
                        <p class="hotel-detail-link"><a href="Villadetail1.jsp" target="_blank"><b>View more information</b></a></p>
                    </div>
                    <div class="hotel-right">
                        <i class="hotel-rate">8.9</i>
                        <i class="hotel-price">800-1000/night</i>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="hotel-frame">
                <div class="hotel-info">
                    <div class="hotel-left">
                        <h3 class="hotel-name">Xiangyuan Villa</h3>
                        <p class="hotel-nation">Bei Jing</p>
                        <img class="hotel-pic" src="../image/image1/villapicture2.jpg" alt="hotel pic">
                        <p class="hotel-detail-link"><a href="villadetail2.jsp" target="_blank"><b>View more information</b></a></p>
                    </div>
                    <div class="hotel-right">
                        <i class="hotel-rate">9.1</i>
                        <i class="hotel-price">1000-1200$/night</i>
                    </div>
                </div>
            </div>
        </div>
